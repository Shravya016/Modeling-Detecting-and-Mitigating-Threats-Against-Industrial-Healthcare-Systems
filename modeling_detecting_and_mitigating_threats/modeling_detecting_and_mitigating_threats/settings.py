...
ROOT_URLCONF = 'modeling_detecting_and_mitigating_threats.urls'
...
WSGI_APPLICATION = 'modeling_detecting_and_mitigating_threats.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'modeling_detecting_and_mitigating_threats',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
