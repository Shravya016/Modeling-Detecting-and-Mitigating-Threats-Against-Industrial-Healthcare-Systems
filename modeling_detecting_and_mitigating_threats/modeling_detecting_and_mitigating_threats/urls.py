"""modeling_detecting_and_mitigating_threats URL Configuration
...
urlpatterns = [
    ...
    url(r'^Predict_Threat_Type/$', remoteuser.Predict_Threat_Type, name="Predict_Threat_Type"),
    ...
    url(r'^Find_Threat_Type_Ratio/$', serviceprovider.Find_Threat_Type_Ratio, name="Find_Threat_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Threat_Type/$', serviceprovider.View_Prediction_Of_Threat_Type, name="View_Prediction_Of_Threat_Type"),
